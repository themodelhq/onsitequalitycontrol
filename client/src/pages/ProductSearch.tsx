...
function exportToExcel(products: EnrichedProduct[], tabLabel: string) {
  const headers = [
    ...
    "Prohibited Item","Blacklisted Keyword","Counterfeit Flag","Suspicious Price",
  ];
  ...
  const rows = products.map((p) => [
    ...
    flag(p.quality,"hasBlacklistedKeyword"),
  ...
  ws["!cols"] = [
    ...
    {wch:20},{wch:14},{wch:16},{wch:16},{wch:20},{wch:18},{wch:16},
  ];
    ...
    try {
      ...
      if (res.ok && res.summary) {
        ...
        quality = {
          ...
          hasProhibitedItem: hasType("prohibited_item") || hasType("restricted_brand"),
        ...
        quality = {
          ...
          hasProhibitedItem: false, hasBlacklistedKeyword: false,
