  ...
  const handleSearch = async (tabId: string) => {
    ...
    try {
      if (tab.mode === "keyword") {
        ...
        // Sending all SKUs at once causes Render's 30s timeout when > ~15 SKUs.
        // Processing 5 per request keeps each call to ~5-10s and shows incremental progress.
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-5 space-y-4">
                  <div className="flex flex-wrap gap-3 items-end">
                    <div>
                      ...
                      <Select value={tab.country} onValueChange={(v) => updateTab(tab.id, { country: v, products: [], error: null, progress: 0 })}>
