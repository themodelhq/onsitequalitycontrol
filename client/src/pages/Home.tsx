        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button size="sm" variant="outline" onClick={() => navigate("/quality-check")} className="gap-1.5">
              <Search size={13} /> Quality Checker
            </Button>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="grid grid-cols-4 gap-4">
          {[
            ...
            { icon: <Search size={20} className="text-purple-500" />, title: "Quality Checker", desc: "Check any live Jumia product URL for quality issues instantly", action: () => navigate("/quality-check"), cta: "Check URL" },
          ].map((item) => (
