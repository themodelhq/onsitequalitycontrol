...
import {
  ...
  TrendingUp, Globe2, ChevronRight, Clock, ShieldAlert, Image, FileText, Tag, Ban, Search, MessageSquare
} from "lucide-react";
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button size="sm" variant="outline" onClick={() => navigate("/product-search")} className="gap-1.5">
              <Search size={13} /> Product Search
            </Button>
            <Button size="sm" variant="outline" onClick={() => navigate("/quality-check")} className="gap-1.5">
              <ShieldAlert size={13} /> Quality Checker
            </Button>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="grid grid-cols-5 gap-4">
          {[
            ...
            { icon: <ShieldAlert size={20} className="text-purple-500" />, title: "Quality Checker", desc: "Check any live Jumia product URL for quality issues instantly", action: () => navigate("/quality-check"), cta: "Check URL" },
            { icon: <Search size={20} className="text-teal-500" />, title: "Product Search", desc: "Search by keyword, URL or SKU — with quality checks and Excel export", action: () => navigate("/product-search"), cta: "Search" },
          ].map((item) => (
